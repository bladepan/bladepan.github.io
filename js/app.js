...
(function (bladepan) {
    ...
    (function (site) {
        ...
        var AppController = (function () {
            ...
            AppController.prototype.sectionClass = function (section) {
        ...
        dataFiles.files = [dataFiles.resume, new DataFile('Virginia Tech Unofficial Academic Transcript', 'XiaozhongPanUnofficialAcademicTranscipt.pdf', true)];
        angular.module('bladepan.site', ['ui.router'], ConfigFn);
        angular.module('bladepan.site').constant('DataFiles', dataFiles);
        angular.module('bladepan.site').controller(AppController.name, AppController).controller('HomeController', HomeController).controller('FilesController', FilesController);
